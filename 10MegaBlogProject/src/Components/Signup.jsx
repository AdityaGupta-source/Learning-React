...
function Signup() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen md:min-h-auto md:py-16 px-4">
        ...
        >
          ...
          <form onSubmit={handleSubmit(create)}>
            <div className='space-y-4 sm:space-y-6'>
              ...
              />
              <Button type="submit" className="w-full py-2.5 sm:py-3 text-sm sm:text-base font-semibold">
                Create Account
              </Button>
            </div>
          </form>
